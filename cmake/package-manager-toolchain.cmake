...
if(DEFINED ENV{VCPKG_ROOT})
	...
	if(EXISTS ${vcpkg_toolchain_path})
		...
		message(WARNING "Vcpkg toolchain file not found at ${vcpkg_toolchain_path}. Ensure vcpkg is properly integrated and installed correctly. See https://vcpkg.io for more information.")
	endif()
